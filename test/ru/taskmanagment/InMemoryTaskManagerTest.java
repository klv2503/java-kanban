...
public class InMemoryTaskManagerTest extends TaskManagerTest {
    ...
    public void shouldCorrectDefineIfSubTaskIsValidByTime() {
        ...
        String errorMessage = "Ошибочно объявлено, что время подзадачи занято";
        ...
        errorMessage = "Ошибочно объявлено, что время подзадачи занято";
        assertEquals(true, isValid, errorMessage);
        ...
        isValid = manager.isValidSubTask(testedSub);
        errorMessage = "Ошибочно объявлено, что время подзадачи допустимо";
        ...
        errorMessage = "Ошибочно объявлено, что время подзадачи занято";
        assertEquals(true, isValid, errorMessage);
        //Теперь совместим финиш тестовой подзадачи с финишом удаленного эпика
